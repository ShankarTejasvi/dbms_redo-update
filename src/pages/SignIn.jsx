...
import { isAdmin, login } from "../slices/userSlice";
              ...
              <div className="max-w-sm mx-auto">
                ...
                <form>
                  ...
                  <div className="flex flex-wrap -mx-3 mt-6">
                    <div className="w-full px-3">
                      <button className="btn text-white bg-purple-600 hover:bg-purple-700 w-full" onClick={handleEmailSignIn}>Sign in</button>
                    </div>
                  </div>
                </form>
